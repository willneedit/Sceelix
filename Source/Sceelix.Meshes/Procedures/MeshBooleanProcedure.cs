...
namespace Sceelix.Meshes.Procedures
{
    ...
    /// </summary>
    [Procedure("8034DF9C-9104-453D-B249-B06D9073AC31", Label = "Mesh Boolean", Category = "Mesh")]
    public class MeshBooleanProcedure : SystemProcedure
    {
        /// <summary>
        /// Inputs and Output
        /// </summary>
        ...
        protected override void Run()
        {
            ...
            Net3dBool.Solid SolidA;
            Net3dBool.Solid SolidB;

            if (!ConvertN3dSolid(meshEntityA, _flipA.Value, "Input A", out SolidA))
                return;

            if(!ConvertN3dSolid(meshEntityB, _flipB.Value, "Input B", out SolidB))
                return;
            ...
            MeshEntity output;
            AssembleMeshEntity(result, out output);
