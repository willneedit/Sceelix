...
namespace Sceelix.Meshes.Procedures
{
    ...
    /// </summary>
    [Procedure("8034DF9C-9104-453D-B249-B06D9073AC33", Label = "Mesh Distort", Category = "Mesh")]
    public class MeshDistortProcedure : SystemProcedure
    {
        /// <summary>
        /// Input and Output
        /// </summary>
        ...
        private readonly List<VertexEx> vertices = new List<VertexEx>();
        ...
        protected override void Run()
        {
            ...
            foreach(Face face1 in meshEntity.Faces)
                foreach(Vertex vertex1 in face1.Vertices)
                {
                    ...
                    vertex1.Position += actualTranslation * r;
                }
